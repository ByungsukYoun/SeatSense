"""
Library Seat Detection - Camera 2
...
TARGET_CLASSES = [0, 24, 56, 63, 67]  # person, backpack, chair, laptop, cell phone
CLASS_NAMES = {
    0: 'person',
    24: 'backpack',
    56: 'chair',
...
COLORS = {
    ...
    'person': (255, 0, 0),       # Blue (person bounding box)
    'object': (0, 255, 255)      # Yellow (object bounding box)
}
...
def blur_face(frame, box):
    ...
    # Estimate face as top 1/3 of person bounding box
    face_height = (y2 - y1) // 3
...
def main():
    print("\n" + "="*60)
    print("     Camera 2 - Seat Occupancy Detection System")
    print("="*60)
    ...
    while True:
        if not paused:
            ...
            if frame_count % 3 == 0:
                results = model(frame, conf=0.3, classes=TARGET_CLASSES, verbose=False)
            ...
            cv2.imshow('Library Seat Detection System - Camera 2', frame)
